...
class NAFNetSR(nn.Module):
    ...
    def __init__(self, up_scale=4, width=48, num_blks=16, img_channel=1, drop_path_rate=0., drop_out_rate=0., fusion_from=-1, fusion_to=-1, dual=False):
        ...
        self.up = nn.Sequential(
            nn.Conv2d(in_channels=width, out_channels=1 * up_scale**2, kernel_size=3, padding=1, stride=1, groups=1, bias=True),
...
class NAFSSR(Local_Base, NAFNetSR):
    def __init__(self, *args, train_size=(1, 6, 30, 90), fast_imp=False, fusion_from=-1, fusion_to=1000, **kwargs):
        ...
        NAFNetSR.__init__(self, *args, img_channel=1, fusion_from=fusion_from, fusion_to=fusion_to, dual=True, **kwargs)
